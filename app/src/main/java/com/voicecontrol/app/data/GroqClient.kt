...
class GroqClient(private val apiKey: String) {
    companion object {
        ...
        private const val SYSTEM_PROMPT = """You are a personal AI assistant living inside an Android app that also controls the phone directly (opens apps, sends messages, sets alarms, reads notifications, adjusts device settings).
